...
type UserServiceClient interface {
	...
	SearchUser(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*UserList, error)
}
...
func (c *userServiceClient) SearchUser(ctx context.Context, in *SearchRequest, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
...
type UserServiceServer interface {
	...
	SearchUser(context.Context, *SearchRequest) (*UserList, error)
...
func (UnimplementedUserServiceServer) SearchUser(context.Context, *SearchRequest) (*UserList, error) {
...
func _UserService_SearchUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SearchUser(ctx, req.(*SearchRequest))
	}
	return interceptor(ctx, in, info, handler)
}
